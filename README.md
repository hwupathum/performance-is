...
./start-performance.sh -k <key_file>
   ...
   [-n <IS_zip_file_path>]
   [-u <db_username>] [-p <db_password>] [-e <db_instance_type>]
   [-i <wso2_is_instance_type>] [-b <bastion_instance_type>] [-t <keystore_type>] [-m <db_type>]
   [-l <is_case_insensitive_username_and_attributes>] [-r <concurrency_type>]
...
-r: Concurrency type (50-500, 500-3000, 50-3000)
