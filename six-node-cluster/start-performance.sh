...
tar -xf target/is-performance-sixnode-cluster*.tar.gz -C "$results_dir"
...
cp 6-node-cluster.yml new-6-node-cluster.yml
sed -i "s/suffix/$random_number/" new-6-node-cluster.yml

echo ""
echo "Validating stack..."
echo "============================================"
aws cloudformation validate-template --template-body file://new-6-node-cluster.yml
